...
It integrates the same dynamics as the `neuron_cli lif` command and the Streamlit app — the subthreshold membrane equation derived in [From a capacitor to the LIF neuron](../ar000/),
