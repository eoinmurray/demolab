...
ARTIFACTS_DIR = Path(__file__).resolve().parents[2] / "artifacts" / "neuron_cli"
...
def setup_run_dir(command: str, args: argparse.Namespace) -> tuple[Path, logging.Logger]:
    ...
    try:
        ...
        script_rel = script
    run_sh = "#!/bin/sh\n"
    run_sh += "# Regenerated by src/clis/neuron_cli/cli.py — reruns this command with the same arguments.\n"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="neuron_cli")
