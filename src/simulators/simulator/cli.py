...
ARTIFACTS_DIR = Path(__file__).resolve().parents[2] / "artifacts" / "simulator"
...
def setup_run_dir(command: str, args: argparse.Namespace) -> tuple[Path, logging.Logger]:
    ...
    logger = logging.getLogger(f"simulator.{command}")
    ...
    try:
        ...
        script_rel = script
    run_sh = "#!/bin/sh\n"
    run_sh += "# Regenerated by src/simulators/simulator/cli.py — reruns this command with the same arguments.\n"
