#import "/.demolab/lib.typ": data-file, cite, reference-list
...
#let body = [
  ...
  The engine itself ships inside the `demolab-cli` package, a black box you never edit and update
  with a dependency bump. Publishing is built on #link("https://typst.app")[Typst], a modern take on LaTeX:
